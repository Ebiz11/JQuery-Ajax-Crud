...
function editUser(id){
    $.ajax({
        ...
        url: 'userAction.php', // menuju ke userAction.php
            ...
            <table class="table table-striped">
                ...
                <tbody id="userData">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);"  onclick="editUser('<?php echo $user['id']; ?>')">Edit</a> |
                            <a href="javascript:void(0);" onclick="return confirm('Are you sure to delete data?')?userAction('delete','<?php echo $user['id']; ?>'):false;">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
